...
\hypersetup{
  pdftitle={Ajuste da Distribuição Generalizada de Valores Extremos para a Precipitações Máximas Diárias no Brasil},
  pdfauthor={Tomas Duval; Saulo AIres de Souza; Dirceu S. Reis Jr.},
  pdfkeywords={Curvas IDF, Informação regional},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\begin{document}
\title{Ajuste da Distribuição Generalizada de Valores Extremos para a
Precipitações Máximas Diárias no Brasil}

\authors{Tomas Duval\affil{1}, Saulo AIres de Souza\affil{2}, Dirceu S.
Reis Jr.\affil{3}}
\affiliation{1}{Curvenote, }\affiliation{2}{Agência Nacinal de Águas e
Saneamento Básico - ANA, }\affiliation{3}{Professor, Departamento de
Engenharia Civil e Ambinetal, Universidade de Brasília, }
\correspondingauthor{Tomas
Duval}{steve@curvenote.com}\correspondingauthor{Saulo AIres de
Souza}{steve@curvenote.com}
...
\subsection{Dados empregados}\label{dados-empregados}

\subsubsection{Leitura dos dados}\label{leitura-dos-dados}

\subsubsection{Tabela Resumo}\label{tabela-resumo}

\subsubsection{Plotagem da estações}\label{plotagem-da-estauxe7uxf5es}

\begin{figure}[H]

\centering{

\includegraphics{index_files/figure-latex/notebooks-explore_daily_precip-fig-number-stations-output-2.png}

}

\caption{\label{fig-number-stations}Número de estações Plu no Brasil}

\end{figure}%

\textsubscript{Source:
\href{https://DirceuReis.github.io/teste-manuscript-quarto/notebooks/explore_daily_precip-preview.html\#cell-fig-number-stations}{Explore
Annual Maximum daily Precipitation in Brazil}}

\subsection{Resultados}\label{resultados}

\subsubsection{\texorpdfstring{Estimativa do parâmetro de forma
\(\kappa\)}{Estimativa do parâmetro de forma \textbackslash kappa}}\label{estimativa-do-paruxe2metro-de-forma-kappa}

\subsection{Introduction}\label{introduction}

\textsubscript{Source:
\href{https://DirceuReis.github.io/teste-manuscript-quarto/index.qmd.html}{Article
Notebook}}
...
\textsubscript{Source:
\href{https://DirceuReis.github.io/teste-manuscript-quarto/notebooks/explore-earthquakes-preview.html\#cell-fig-spatial-plot}{Explore
Earthquakes}}
