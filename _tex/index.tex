...
\section{Dados empregados}\label{dados-empregados}

\subsection{Leitura dos dados}\label{leitura-dos-dados}

\subsection{Tabela Resumo}\label{tabela-resumo}

\subsection{Plotagem da estações}\label{plotagem-da-estauxe7uxf5es}

\begin{figure}[H]

\centering{

\includegraphics{index_files/figure-latex/notebooks-explore_daily_precip-fig-number-stations-output-1.png}
...
\subsection{\texorpdfstring{Estimativa do parâmetro de forma
